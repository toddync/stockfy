  ...
  return (
    <div className="page-container p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="text-center p-10">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Página de Itens de Compra Desativada</h1>
        <p className="text-gray-600 mb-6">
          A funcionalidade de gerenciamento de itens de compra foi unificada na página de "Nova Compra".
        </p>
        <button 
