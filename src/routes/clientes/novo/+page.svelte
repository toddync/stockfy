<script lang="ts">
    ...
    async function save() {
        ...
        try {
            ...
            await db.execute(
                `INSERT INTO clientes (${q.columns}) VALUES (${q.placeholders})`,
                q.values,
            );
    ...
    async function loadAuxiliaryData() {
        try {
            const [pracasRes, rotasRes] = await Promise.all([
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card.Root class="md:col-span-2">
            <Card.Header>
                ...
                <Card.Description>
                    Dados principais e de contato do cliente.
                </Card.Description>
            </Card.Header>
            <Card.Content class="space-y-4">
                <div class="grid gap-2">
                    <Label for="nome">
                        Nome Completo / Razão Social <Needed />
                    </Label>
                    <Input
                        id="nome"
