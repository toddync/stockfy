<script lang="ts">
    ...
    import type { Cliente, PedidoItem, Produto, Vendedor } from "@/types";
    ...
    async function save() {
        ...
        try {
            ...
            const savedOrder = await db.execute(
                `INSERT INTO pedidos (${queryHelper(pedidoToSave).columns}) VALUES (${queryHelper(pedidoToSave).placeholders})`,
                queryHelper(pedidoToSave).values,
            );

            const pedidoId = savedOrder.lastInsertId;
    ...
    async function loadAuxiliaryData() {
        try {
            ...
            clientes = c as Array<Cliente>;
            vendedores = v as Array<Vendedor>;
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card.Root class="md:col-span-2">
            <Card.Header>
                ...
                <Card.Description>Dados principais da venda.</Card.Description>
            </Card.Header>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            <Select.Content>
                                <Select.Item value="venda">Venda</Select.Item>
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            <Select.Trigger class="w-full">
                                {clientes.find(
                                    (c) =>
                                        String(c.id) === orderData.cliente_id,
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            <Select.Trigger class="w-full">
                                {vendedores.find(
                                    (v) =>
                                        String(v.id) === orderData.vendedor_id,
        ...
        <Card.Root>
            ...
            <Card.Content class="space-y-4">
                <div class="flex justify-between items-center text-sm">
                    <span class="text-muted-foreground">Subtotal (Bruto):</span>
                ...
                <div class="grid gap-2 pt-4">
                    ...
                    <Select.Root type="single" bind:value={orderData.situacao}>
                        <Select.Trigger class="w-full capitalize">
                            {orderData.situacao}
                        </Select.Trigger>
                        <Select.Content>
                            <Select.Item value="pendente">Pendente</Select.Item>
                            <Select.Item value="faturado">Faturado</Select.Item>
        ...
        <Card.Root class="md:col-span-3">
            <Card.Header>
                ...
                <Card.Description
                    >Adicione os produtos a este pedido.</Card.Description
                >
            </Card.Header>
