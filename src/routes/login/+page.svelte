...
>
  <div class="w-full max-w-md space-y-8">
    ...
    <Card.Root class="border-none shadow-2xl bg-background/60 backdrop-blur-xl">
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                onclick={() => {}}>Esqueceu a senha?</button
              >
            </div>
            <Input
              id="password"
      ...
      <Card.Footer class="flex flex-col border-t p-6 bg-muted/20">
        <p class="text-xs text-center text-muted-foreground">
          ...
          <button
            ...
            onclick={() => {}}>Termos de Serviço</button
          >
          e
          <button
            type="button"
            class="text-primary hover:underline cursor-pointer"
            onclick={() => {}}>Política de Privacidade</button
          >.
        </p>
      </Card.Footer>
    </Card.Root>
