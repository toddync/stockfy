...
<div
    class="flex min-h-[calc(100svh-32px)] items-center justify-center bg-muted/40 px-4 py-12 sm:px-6 lg:px-8"
>
    <div class="w-full max-w-md space-y-8">
        ...
        <Card.Root class="shadow-2xl bg-background/60 backdrop-blur-xl pb-0">
