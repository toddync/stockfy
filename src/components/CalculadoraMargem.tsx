...
const CalculadoraMargem: React.FC<CalculadoraMargemProps> = ({ precoCusto, precoVenda, onMargemChange }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
      <h3 className="text-lg font-semibold text-gray-700 mb-2">Calculadora de Margem</h3>
      <div className="grid grid-cols-2 gap-3 text-sm">
        <div>
          <label htmlFor="custo" className="block text-gray-600 mb-1">Preço de Custo:</label>
          <input
            type="number"
            id="custo"
            value={custo}
        ...
        <div>
          <label htmlFor="venda" className="block text-gray-600 mb-1">Preço de Venda:</label>
          <input
            type="number"
            id="venda"
            value={venda}
        ...
        <div className="col-span-2 mt-2">
          <p className="text-gray-700 font-medium">Margem de Lucro: 
            <span className={`ml-2 font-bold ${margemLucro > 0 ? 'text-green-600' : 'text-red-600'}`}>
