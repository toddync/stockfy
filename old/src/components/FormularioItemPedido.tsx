      ...
      <div className="form-container bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="mb-4">
          ...
          {produtoSelecionado && (
            <p className="text-gray-600 text-sm mt-2">
              Produto selecionado: {produtoSelecionado.descricao} (Cód: {produtoSelecionado.codigo}) - R$ {produtoSelecionado.preco_venda}
            </p>
          )}
        </div>
        ...
        {produtoSelecionado && (
          <div className="bg-gray-100 p-3 rounded-md mb-4">
            ...
            <br />
            <strong className="text-green-700">Total: R$ {(quantidade * produtoSelecionado.preco_venda)}</strong>
          </div>
        )}
