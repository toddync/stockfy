      ...
      <div className="bg-gray-100 p-4 rounded-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex flex-col">
            ...
            <span className="text-lg font-bold text-blue-600">R$ {simulatedPrice}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-gray-600 text-sm">Lucro Simulado:</span>
            <span className="text-lg font-bold text-green-600">R$ {simulatedProfit}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-gray-600 text-sm">Margem Simulado:</span>
            <span className="text-lg font-bold text-purple-600">{simulatedMargin}%</span>
          </div>
        </div>
      </div>
    </div>
